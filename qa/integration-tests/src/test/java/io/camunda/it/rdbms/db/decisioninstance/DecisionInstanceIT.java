...
public class DecisionInstanceIT {
  ...
  public void shouldFindAllDecisionInstancePaged(
    ...
    assertThat(searchResult.sortValues())
        .containsExactly(
            lastInstance.evaluationDate(), lastInstance.decisionName(), lastInstance.key());
  }
  ...
  public void shouldFindDecisionInstanceWithFullFilter(
    ...
    assertThat(searchResult.items().getFirst().key()).isEqualTo(instance.decisionInstanceKey());
  }
                        ...
                        .page(
                            p ->
                                p.size(5)
                                    .searchAfter(
                                        new Object[] {
                                          instanceAfter.decisionName(),
                                          instanceAfter.decisionVersion(),
