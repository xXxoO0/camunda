...
public class DecisionDefinitionSortIT {
  ...
  public void shouldSortByDecisionDefinitionIdAsc(
    ...
    testSorting(
        ...
        Comparator.comparing(DecisionDefinitionEntity::decisionId));
  }
  ...
  public void shouldSortByDecisionDefinitionIdDesc(
    ...
    testSorting(
        ...
        Comparator.comparing(DecisionDefinitionEntity::decisionId).reversed());
  }
  ...
  public void shouldSortByDecisionDefinitionKeyAsc(
    ...
    testSorting(
        ...
        Comparator.comparing(DecisionDefinitionEntity::key));
  }
  ...
  public void shouldSortByDecisionDefinitionKeyDesc(
    ...
    testSorting(
        ...
        Comparator.comparing(DecisionDefinitionEntity::key).reversed());
  }
