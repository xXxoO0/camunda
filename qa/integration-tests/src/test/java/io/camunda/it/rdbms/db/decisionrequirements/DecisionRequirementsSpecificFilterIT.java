...
public class DecisionRequirementsSpecificFilterIT {
  ...
  @ParameterizedTest
  @MethodSource("shouldFindDecisionRequirementsWithSpecificFilterParameters")
  public void shouldFindDecisionRequirementsWithSpecificFilter(
  ...
  static List<DecisionRequirementsFilter>
      shouldFindDecisionRequirementsWithSpecificFilterParameters() {
    return List.of(
