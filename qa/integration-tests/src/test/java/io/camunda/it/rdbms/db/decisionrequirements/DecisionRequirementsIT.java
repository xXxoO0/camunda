...
public class DecisionRequirementsIT {
  ...
  @TestTemplate
  public void shouldSaveAndFindDecisionRequirementsByKey(
    ...
    assertThat(instance.key()).isEqualTo(decisionRequirements.decisionRequirementsKey());
  ...
  @TestTemplate
  public void shouldFindAllDecisionRequirementsPaged(
      final CamundaRdbmsTestApplication testApplication) {
    final RdbmsService rdbmsService = testApplication.getRdbmsService();
    final RdbmsWriter rdbmsWriter = rdbmsService.createWriter(PARTITION_ID);
    final DecisionRequirementsReader decisionRequirementsReader =
  ...
  public void shouldFindAllProcessInstancePageValuesAreNull(
    ...
    final var searchResult =
        decisionRequirementsReader.search(
            new DecisionRequirementsQuery(
                new DecisionRequirementsFilter.Builder().build(),
                DecisionRequirementsSort.of(b -> b),
  ...
  @TestTemplate
  public void shouldFindDecisionRequirementssWithSearchAfter(
      final CamundaRdbmsTestApplication testApplication) {
    final RdbmsService rdbmsService = testApplication.getRdbmsService();
    final RdbmsWriter rdbmsWriter = rdbmsService.createWriter(PARTITION_ID);
    final DecisionRequirementsReader decisionRequirementsReader =
