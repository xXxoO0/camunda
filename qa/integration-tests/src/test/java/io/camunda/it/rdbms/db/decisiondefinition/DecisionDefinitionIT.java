...
public class DecisionDefinitionIT {
  ...
  @TestTemplate
  public void shouldSaveAndFindDecisionDefinitionByKey(
    ...
    assertThat(instance.key()).isEqualTo(decisionDefinition.decisionDefinitionKey());
    ...
    assertThat(instance.decisionId()).isEqualTo(decisionDefinition.decisionDefinitionId());
  ...
  @TestTemplate
  public void shouldFindAllDecisionDefinitionPaged(
      final CamundaRdbmsTestApplication testApplication) {
    final RdbmsService rdbmsService = testApplication.getRdbmsService();
    final RdbmsWriter rdbmsWriter = rdbmsService.createWriter(PARTITION_ID);
    final DecisionDefinitionReader decisionDefinitionReader =
  ...
  @TestTemplate
  public void shouldFindDecisionDefinitionsWithSearchAfter(
      final CamundaRdbmsTestApplication testApplication) {
    final RdbmsService rdbmsService = testApplication.getRdbmsService();
    final RdbmsWriter rdbmsWriter = rdbmsService.createWriter(PARTITION_ID);
    final DecisionDefinitionReader decisionDefinitionReader =
