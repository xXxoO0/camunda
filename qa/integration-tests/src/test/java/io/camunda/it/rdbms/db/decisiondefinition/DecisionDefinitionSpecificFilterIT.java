...
public class DecisionDefinitionSpecificFilterIT {
  ...
  @ParameterizedTest
  @MethodSource("shouldFindDecisionDefinitionWithSpecificFilterParameters")
  public void shouldFindDecisionDefinitionWithSpecificFilter(
  ...
  static List<DecisionDefinitionFilter> shouldFindDecisionDefinitionWithSpecificFilterParameters() {
    return List.of(
